...
public class Prog04Login extends javax.swing.JFrame {

	private static final long serialVersionUID = -6713397761379754837L;
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		if (usuario.isEmpty() || paswd.isEmpty()) {
			...
			if (usuario.equals("usuario") && paswd.equals("1234")) {
				...
				JOptionPane.showConfirmDialog(null, "No se pudo conectar");
			}
		}
	}
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(Prog04Login.class.getName()).log(java.util.logging.Level.SEVERE, null,
					ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Prog04Login().setVisible(true);
